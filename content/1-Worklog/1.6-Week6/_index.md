...
| 4   | - Study Amazon Redshift and Amazon ElastiCache <br>&emsp; + Amazon Redshift: Data Warehouse, MPP architecture, columnar storage, cost optimization features <br>&emsp; + Amazon ElastiCache: caching service, Redis and Memcached support <br>&emsp; + Introduction to DMS and SCT | 28/05/2026 | 28/05/2026      | https://youtu.be/UvdiRW34aNI?si=2PaDwqh7ka21Bv_6 |
| 5   | - **Lab5: Introduction to Amazon Relational Database Service (Amazon RDS)** <br>&emsp; + Create and configure RDS instance <br>&emsp; + Learn about RDS features (Multi-AZ, Read Replicas, Snapshots) | 29/05/2026 | 29/05/2026      | https://000005.awsstudygroup.com/J |
...
* Completed Module 6 and mastered all knowledge about AWS databases:
  ...
  * Distinguished between RDBMS and NoSQL, OLTP and OLAP.
  * Understood and mastered Amazon RDS and key features.
  * Understood Amazon Aurora features, differences and advanced features.
  * Understood Amazon Redshift (Data Warehouse, MPP architecture) and Amazon ElastiCache.
  * Got introduced to DMS and SCT.
* Successfully practiced Lab5: Introduction to Amazon RDS.
* Read and understood Lab43 content but not completed due to errors.
