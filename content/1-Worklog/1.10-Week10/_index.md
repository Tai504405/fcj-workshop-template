...
| --- | --- | --- | --- | --- |
| Mon | Build a dedicated VPC (`globalmart-vpc`, CIDR `10.0.0.0/16`) and allocate public and private subnets. | 22/06/2026 | 22/06/2026 | [GitHub Repository](https://github.com/KENTksl/globalmart-production-cicd.git) |
| Tue | Configure Internet Gateways, NAT Gateways, and set up Route Tables for subnets. | 23/06/2026 | 23/06/2026 | [GitHub Repository](https://github.com/KENTksl/globalmart-production-cicd.git) |
| Wed | Configure layered Security Group rules, locking port 3306 database ingress to backend nodes. | 24/06/2026 | 24/06/2026 | [GitHub Repository](https://github.com/KENTksl/globalmart-production-cicd.git) |
...
| Fri | Deploy a temporary bastion EC2 instance to execute database schema seeding. Week 10 review. | 26/06/2026 | 26/06/2026 | [GitHub Repository](https://github.com/KENTksl/globalmart-production-cicd.git) |
