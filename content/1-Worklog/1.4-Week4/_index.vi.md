...
pre: " <b> 1.4. </b> "
---
### Định hướng & Mục tiêu Tuần 4:

* Đã hoàn tất học phần Module 4 và nắm toàn bộ kiến thức về dịch vụ lưu trữ trên AWS (S3, Snow Family, Storage Gateway, Disaster Recovery).
...
* Đã hoàn tất học phần Module 4 và nắm toàn bộ kiến thức về dịch vụ lưu trữ trên AWS:
...
* Luyện tập thực hành toàn bộ các lab theo lộ trình Module 4:
