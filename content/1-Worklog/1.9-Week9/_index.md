...
| --- | --- | --- | --- | --- |
| Mon | Write a Dockerfile for the React frontend utilizing Nginx to serve static files. | 15/06/2026 | 15/06/2026 | Project Codebase |
| Tue | Draft a multi-stage Dockerfile for the Spring Boot backend jar service to minimize output size. | 16/06/2026 | 16/06/2026 | Project Codebase |
