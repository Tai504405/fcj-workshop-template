...
| --- | --- | --- | --- | --- |
| Thứ 2 | Nghiên cứu Docker, viết Dockerfile cho Frontend (React) sử dụng máy chủ Nginx để tối ưu hóa tệp tĩnh. | 15/06/2026 | 15/06/2026 | Mã nguồn dự án |
| Thứ 3 | Viết Dockerfile cho Backend (Spring Boot Java), tối ưu hóa thời gian build và dung lượng tệp JAR thành phẩm. | 16/06/2026 | 16/06/2026 | Mã nguồn dự án |
